import{j as e}from"./vendor-three-DDa8oPrP.js";import{u as i}from"./vendor-react-CSErxCQx.js";const n=[{id:"sun",glyph:"日",name:"人格测评",route:"/personality",size:84,core:"#fff5e0",mid:"#f0c674",deep:"#d4a84b",glow:"rgba(240,198,116,0.5)",orbitDur:12},{id:"coffee",glyph:"咖",name:"香氛实验室",route:"/brew/scent",size:100,core:"#d4b896",mid:"#8b6f47",deep:"#5c4530",glow:"rgba(139,111,71,0.4)",orbitDur:16},{id:"tea",glyph:"茶",name:"棋局",route:"/chess",size:108,core:"#b8d4a8",mid:"#6b8e6b",deep:"#3d5c3d",glow:"rgba(107,142,107,0.4)",orbitDur:14},{id:"wine",glyph:"酒",name:"人格调酒",route:"/cocktail",size:132,core:"#c4a8e0",mid:"#7c5fbf",deep:"#2d1b4e",glow:"rgba(124,95,191,0.5)",orbitDur:10},{id:"moon",glyph:"月",name:"牌",route:"/cards",size:92,core:"#f0eaff",mid:"#d8c9f5",deep:"#8a7bb0",glow:"rgba(216,201,245,0.4)",orbitDur:18}];function l(){const t=i();return e.jsxs("div",{className:"hub-root",children:[e.jsx("div",{className:"hub-stars"}),e.jsx("div",{className:"hub-nebula hub-nebula-a"}),e.jsx("div",{className:"hub-nebula hub-nebula-b"}),e.jsx("button",{className:"hub-back",onClick:()=>t("/"),"aria-label":"返回首页",children:"← 入镜"}),e.jsxs("header",{className:"hub-header",children:[e.jsx("div",{className:"hub-eyebrow",children:"JUEZUI · 觉醉"}),e.jsx("h1",{className:"hub-title",children:"踏入你的星球"}),e.jsx("p",{className:"hub-subtitle",children:"日 · 咖 · 茶 · 酒 · 月 · 五重宇宙入夜"})]}),e.jsx("div",{className:"hub-planets",children:n.map((a,r)=>e.jsxs("button",{className:`hub-planet-btn ${a.id==="wine"?"main":""}`,style:{"--p-size":`${a.size}px`,"--p-core":a.core,"--p-mid":a.mid,"--p-deep":a.deep,"--p-glow":a.glow,"--p-orbit-dur":`${a.orbitDur}s`,"--p-delay":`${r*.4}s`},onClick:()=>t(a.route),"aria-label":`${a.glyph} · ${a.name}`,children:[e.jsx("div",{className:"hub-orbit-ring"}),e.jsx("div",{className:"hub-planet-body"}),e.jsx("div",{className:"hub-planet-glow"}),e.jsxs("div",{className:"hub-planet-label",children:[e.jsx("span",{className:"hub-glyph",children:a.glyph}),e.jsx("span",{className:"hub-name",children:a.name})]})]},a.id))}),e.jsx("style",{children:`
        .hub-root {
          position: fixed;
          inset: 0;
          background: #070414;
